...
function Chilla(configuration){
	...
	this.contentTypes = {};
	this.themeRoot = this.appPath + forPlatform('/themes/default/');
	this.templatesRoot = this.themeRoot + forPlatform('templates/');
	this.layoutRoot = this.templatesRoot + forPlatform('layouts/');
	this.contentTypesFolder = configuration.contentTypesFolder || __dirname + forPlatform('/contentTypes');
